    	...
    	<div className="container">
    		<div className="row">
    			<div className="col-md-6">
    				<img src={require(`../../assets/images/prod-1.png`)} className="img-fluid" alt="" />
    			</div>
    			<div className="col-md-6">
    				...
    				<div id="timer" className="d-flex mb-4">
						...
						<div className="text-deal">
							...
							<ul className="thumb-deal d-flex mt-4">
								<li className="img" style={{ backgroundImage: `url(${require('../../assets/images/product-1.jpg')}`}}></li>
								<li className="img" style={{ backgroundImage: `url(${require('../../assets/images/product-2.jpg')}`}}></li>
								<li className="img" style={{ backgroundImage: `url(${require('../../assets/images/product-4.jpg')}`}}></li>
							</ul>
						</div>
    			</div>
    		</div>
