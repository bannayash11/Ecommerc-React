...
<>
<div className="hero-wrap hero-bread" style="background-image: url('images/bg_6.jpg');">
    ...
    <section className="ftco-section">
    	<div className="container">
    		<div className="row">
              ...
              <img src="images/product-1.png" className="img-fluid" alt="Colorlib Template" />
            </a>
    			</div>
              	...
              	<div className="row p-4">
						   		<div className="col-md-7">
						   			...
						   			<div className="review">
								   		<div className="user-img" style="background-image: url(images/person_1.jpg)"></div>
								   		<div className="desc">
								   			<h4>
								   	...
								   	<div className="review">
								   		<div className="user-img" style="background-image: url(images/person_2.jpg)"></div>
								   		<div className="desc">
								   			<h4>
								   				<span className="text-left">Jacob Webb</span>
								   				<span className="text-right">14 March 2018</span>
								   	...
								   	<div className="review">
								   		<div className="user-img" style="background-image: url(images/person_3.jpg)"></div>
								   		<div className="desc">
								   			<h4>
								   				<span className="text-left">Jacob Webb</span>
								   				<span className="text-right">14 March 2018</span>
