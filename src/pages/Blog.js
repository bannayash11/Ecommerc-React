      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-8 order-lg-last ftco-animate">
             ...
             <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../assets/images/image_1.jpg')}`}}>
		              </a>
		          ...
		          <div className="col-md-12 d-flex ftco-animate">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../assets/images/image_2.jpg')}`}}>
		              </a>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><a href="#">April 9, 2019</a></div>
		          ...
		          <div className="col-md-12 d-flex ftco-animate">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../assets/images/image_3.jpg')}`}}>
		              </a>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><a href="#">April 9, 2019</a></div>
		          ...
		          <div className="col-md-12 d-flex ftco-animate">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../assets/images/image_5.jpg')}`}}>
		              </a>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><a href="#">April 9, 2019</a></div>
		          ...
		          <div className="col-md-12 d-flex ftco-animate">
		            <div className="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" className="block-20" style={{ backgroundImage: `url(${require('../assets/images/image_6.jpg')}`}}>
		              </a>
		              <div className="text d-block pl-md-4">
		              	<div className="meta mb-3">
		                  <div><a href="#">April 9, 2019</a></div>
          ...
          <div className="col-lg-4 sidebar ftco-animate">
            ...
            <div className="sidebar-box ftco-animate">
              ...
              <div className="block-21 mb-4 d-flex">
                <a className="blog-img mr-4" style={{ backgroundImage: `url(${require('../assets/images/image_1.jpg')}`}}></a>
                <div className="text">
              ...
              <div className="block-21 mb-4 d-flex">
                <a className="blog-img mr-4" style={{ backgroundImage: `url(${require('../assets/images/image_2.jpg')}`}}></a>
                <div className="text">
                  <h3 className="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div className="meta">
                    <div><a href="#"><span className="icon-calendar"></span> April 27, 2019</a></div>
              ...
              <div className="block-21 mb-4 d-flex">
                <a className="blog-img mr-4" style={{ backgroundImage: `url(${require('../assets/images/image_3.jpg')}`}}></a>
                <div className="text">
                  <h3 className="heading-1"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div className="meta">
                    <div><a href="#"><span className="icon-calendar"></span> April 27, 2019</a></div>
