...
export default function Offerandcategory() {
  return (
<>
    	...
    	<div className="container">
				<div className="row no-gutters">
					<div className="col-lg-4">
                        ...
                        style={{ backgroundImage: `url(https://themewagon.github.io/minishop/images/choose-1.jpg)` }}>
    				...
    				<div className="row no-gutters choose-wrap divider-two align-items-stretch">
    					<div className="col-md-12">
	    					<div className="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style={{ backgroundImage: `url(https://themewagon.github.io/minishop/images/choose-2.jpg)` }}>
    					...
    					<div className="col-md-12">
    						<div className="row no-gutters">
	    						...
	    						<div className="col-md-6">
		    						<div className="choose-wrap wrap img align-self-stretch d-flex align-items-center"  style={{ backgroundImage: `url(https://themewagon.github.io/minishop/images/choose-3.jpg)` }}>
